...
while n <= Number_solutions:
    ...
    NPC.append(Utopia.NPC.value)
    total_emission.append(Utopia.total_emission.value)
    
    #%% 
    # Save the results as csv file in the previous folder
    if not os.path.exists("examples/Planning_teaching/results_" + str(n)):
        os.mkdir("examples/Planning_teaching/results_" + str(n))
        
    Utopia.to_csv(
        path= "examples/Planning_teaching/results_" + str(n),                          # Path to the destination folder for the results
        force_rewrite=True,                                                 # Overwrite the parameters files (True) or not (False)
    ...
    if not os.path.exists("examples/Planning_teaching/plots_" + str(n)):
        os.mkdir("examples/Planning_teaching/plots_" + str(n))
        
    plots.plot_total_capacity(
        path = "examples/Planning_teaching/plots_" + str(n) + "/totalcapacity.html",       # Path to the folder in which the plot will be saved
    ...
    plots.plot_new_capacity(
        path = "examples/Planning_teaching/plots_" + str(n) + "/newcapacity.html",         # Path to the folder in which the plot will be saved
        tech_group = 'Power Generation',                                    # The group of the techs, reported in the configuration file, to be plotted
        kind="bar",                                                         # "Bar" or "Area" are the two kind of plots accepted
    ...
    plots.plot_prod_by_tech(
        path = "examples/Planning_teaching/plots_" + str(n) + "/prod_by_tech.html",        # Path to the folder in which the plot will be saved
        tech_group = 'Power Generation',                                    # The group of the techs, reported in the configuration file, to be plotted
        kind="bar",                                                         # "Bar" or "Area" are the two kind of plots accepted
        regions="all",                                                      # The regions considered. "all" to consider all of them, ["reg1", ...] to consider only some regions
        aggregate=False                                                     # True to aggregate the results of each region, False to plot them separately
    ...
    plots.plot_use_by_technology(
        path = "examples/Planning_teaching/plots_" + str(n) + "/use_by_tech.html",         # Path to the folder in which the plot will be saved
    ...
    plots.plot_fuel_prod_cons(
        path = "examples/Planning_teaching/plots_" + str(n) + "/prod_con_share_2020.html",     # Path to the folder in which the plot will be saved
    ...
    plots.plot_fuel_prod_cons(
        path = "examples/Planning_teaching/plots_" + str(n) + "/prod_con_share_2030.html",     # Path to the folder in which the plot will be saved
    ...
    plots.plot_emissions(
        path = "examples/Planning_teaching/plots_" + str(n) + "/emissions.html",           # Path to the folder in which the plot will be saved
        tech_group = 'Power Generation',                                    # The group of the techs, reported in the configuration file, to be plotted
    ...
    plots.plot_hourly_prod_by_tech(
        path = "examples/Planning_teaching/plots_" + str(n) + "/hourlyprod_2020_January.html",     # Path to the folder in which the plot will be saved
        tech_group = 'Power Generation',                                    # The group of the techs, reported in the configuration file, to be plotted
        fuel_group = 'Electricity',                                         # The group of the carriers, reported in the configuration file, to be plotted
        kind = "bar",                                                       # "Bar" or "Area" are the two kind of plots accepted
    ...
    plots.plot_hourly_prod_by_tech(
        path = "examples/Planning_teaching/plots_" + str(n) + "/hourlyprod_2020_July.html",     # Path to the folder in which the plot will be saved
        tech_group = 'Power Generation',                                    # The group of the techs, reported in the configuration file, to be plotted
        fuel_group = 'Electricity',                                         # The group of the carriers, reported in the configuration file, to be plotted
        kind = "bar",                                                       # "Bar" or "Area" are the two kind of plots accepted
        year = ["Y0"],                                                      # Year considered 
    ...
    plots.plot_hourly_prod_by_tech(
        path = "examples/Planning_teaching/plots_" + str(n) + "/hourlyprod_2030_January.html",     # Path to the folder in which the plot will be saved
        tech_group = 'Power Generation',                                    # The group of the techs, reported in the configuration file, to be plotted
        fuel_group = 'Electricity',                                         # The group of the carriers, reported in the configuration file, to be plotted
        kind = "bar",                                                       # "Bar" or "Area" are the two kind of plots accepted
    ...
    plots.plot_hourly_prod_by_tech(
        path = "examples/Planning_teaching/plots_" + str(n) + "/hourlyprod_2030_July.html",     # Path to the folder in which the plot will be saved
        tech_group = 'Power Generation',                                    # The group of the techs, reported in the configuration file, to be plotted
        fuel_group = 'Electricity',                                         # The group of the carriers, reported in the configuration file, to be plotted
        kind = "bar",                                                       # "Bar" or "Area" are the two kind of plots accepted
        year = ["Y10"],                                                     # Year considered 
    ...
    plots.plot_regional_costs(
        path = "examples/Planning_teaching/plots_" + str(n) + "/regionalcost_by_tech.html", # Path to the folder in which the plot will be saved
    ...
    #%%
    # update weight and solution
    
    n += 1
    w = w - 1/Number_solutions
    
#%%
# Pareto frontier 

plots.pareto_frontier(
    path = "examples/Planning_teaching/ParetoFrontier.html", 
    NPC = NPC,
